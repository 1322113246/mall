...
import com.lb.gulimail.member.service.MemberReceiveAddressService;
...
public class MemberReceiveAddressController {
    ...
    @GetMapping("/address")
    public List<MemberReceiveAddressEntity> getAddr(@RequestParam("memberId") Long memberId){
        return memberReceiveAddressService.getAddr(memberId);
    }
    /**
     * 列表
     */
